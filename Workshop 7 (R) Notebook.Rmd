...
We re-run the model assumptions tests.
...
### Exercise 7.28. Visualizing the uncertainty in the model parameters
...
ggplot() +
  ...
  labs(
    # title = "Regression Line with 95% Confidence and 99% Prediction Intervals",
    x = "x", y = "y"
  ) +
  # theme_minimal() +
...
# Exercise 7.29. Creating expectations for the hold-out period
...
# Plot predictions with intervals and actuals with customized legend
ggplot(pred_df, aes(x = date)) +
  # Plot the predicted values as a line
  geom_line(aes(y = fit, color = "Expectation"), size = 1) +  
  ...
  labs(
    # title = "Expectations of Revenue with 99% Prediction Interval and Recorded Values",
    x = "Date",
    y = "Revenue"
  ) +
  scale_x_date(
...
Combining 12 monthly predictions
