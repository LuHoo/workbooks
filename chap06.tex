...
\bigskip
Which size difference requires further investigation? The answer to this question hinges on the risk that the auditor wishes to control, and our argument is similar to that discussed in Volume 1 regarding hypothesis testing. 

We begin with Step 1 in the nine-step approach\index{nine-step approach} from Volume 1 (in the hypothesis testing chapter): the research question. Section \ref{sub:account_and_assertions} provides details, for example, whether the auditor is concerned about overstatements, understatements, or both.
