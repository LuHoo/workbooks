...
render_derived_outputs <- function(resolved_entries) {
  ...
  reg_mod0_rows_id <- "reg.summary.mod0_rows"
  reg_mod0_rows_target_snippet <- "generated/worked-calculations/reg-summary-mod0-rows.tex"
  reg_mod1_rows_id <- "reg.summary.mod1_rows"
  reg_mod1_rows_target_snippet <- "generated/worked-calculations/reg-summary-mod1-rows.tex"
  reg_mod2_rows_id <- "reg.summary.mod2_rows"
  reg_mod2_rows_target_snippet <- "generated/worked-calculations/reg-summary-mod2-rows.tex"
  reg_mod3_rows_id <- "reg.summary.mod3_rows"
  reg_mod3_rows_target_snippet <- "generated/worked-calculations/reg-summary-mod3-rows.tex"
  reg_mod4_rows_id <- "reg.summary.mod4_rows"
  reg_mod4_rows_target_snippet <- "generated/worked-calculations/reg-summary-mod4-rows.tex"
  reg_mod5_rows_id <- "reg.summary.mod5_rows"
  reg_mod5_rows_target_snippet <- "generated/worked-calculations/reg-summary-mod5-rows.tex"

  filter_values_by_role_prefix <- function(entry_id, prefix) {
    entry <- by_id[[entry_id]]
    if (is.null(entry)) {
      stop("Missing resolved metadata for ", entry_id, call. = FALSE)
    }
    Filter(function(v) startsWith(v$role, prefix), entry$values)
  }

  build_reg_rows_metadata <- function(id, target_snippet, role_prefix, source_context, source_dataset) {
    mc_group(
      id = id,
      kind = "inline_values",
      source_notebook = reg_derived_source_notebook,
      source_context = source_context,
      source_dataset = source_dataset,
      target_snippet = target_snippet,
      tolerance = 1e-8,
      language_scope = "r",
      values = filter_values_by_role_prefix(reg_derived_id, role_prefix)
    )
  }

  reg_mod0_rows_metadata <- build_reg_rows_metadata(
    reg_mod0_rows_id,
    reg_mod0_rows_target_snippet,
    "mod0_",
    "Derived mod.0 coefficient table rows for regression chapter",
    "USSteamCo simple model summary"
  )

  reg_mod1_rows_metadata <- build_reg_rows_metadata(
    reg_mod1_rows_id,
    reg_mod1_rows_target_snippet,
    "mod1_",
    "Derived mod.1 coefficient table rows for regression chapter",
    "USSteamCo multiple model summary"
  )

  reg_mod2_rows_metadata <- build_reg_rows_metadata(
    reg_mod2_rows_id,
    reg_mod2_rows_target_snippet,
    "mod2_",
    "Derived mod.2 coefficient table rows for regression chapter",
    "USSteamCo interaction model summary"
  )

  reg_mod3_rows_metadata <- build_reg_rows_metadata(
    reg_mod3_rows_id,
    reg_mod3_rows_target_snippet,
    "mod3_",
    "Derived mod.3 coefficient table rows for regression chapter",
    "USSteamCo winsorized model summary"
  )

  reg_mod4_rows_metadata <- build_reg_rows_metadata(
    reg_mod4_rows_id,
    reg_mod4_rows_target_snippet,
    "mod4_",
    "Derived mod.4 coefficient table rows for regression chapter",
    "USSteamCo transformed model summaries"
  )

  reg_mod5_rows_metadata <- build_reg_rows_metadata(
    reg_mod5_rows_id,
    reg_mod5_rows_target_snippet,
    "mod5_",
    "Derived mod.5 coefficient table rows for regression chapter",
    "USSteamCo refined model summary"
  )
  ...
  list(
    ...
    list(
      ...
      content = c(
        ...
        macro_line("RegModZeroTCritNinetyNine", get_display("reg.inline.linked_values", "mod0_t_99")),
        ...
        macro_line("RegModZeroPrecisionCritNinetyNine", get_display("reg.inline.linked_values", "mod0_precision_99")),
        macro_line("RegModZeroRSquared", get_display("reg.inline.linked_values", "mod0_r_squared")),
        macro_line("RegModOneResidualSd", get_display("reg.inline.linked_values", "mod1_residual_sd")),
        macro_line("RegModOneRSquared", get_display("reg.inline.linked_values", "mod1_r_squared")),
        macro_line("RegModTwoResidualSd", get_display("reg.inline.linked_values", "mod2_residual_sd")),
        macro_line("RegModTwoRSquared", get_display("reg.inline.linked_values", "mod2_r_squared"))
      ),
      metadata = by_id[[reg_derived_id]],
      target_snippet = reg_derived_target_snippet
    ),
    list(
      filename = "reg-summary-mod0-rows.tex",
      content = c(
        "% Generated by scripts/generate-worked-calculations.R; do not edit by hand.",
        "% Derived from Regression inline-linked notebook values (mod.0 summary rows).",
        paste0("% Registry ID: ", reg_mod0_rows_id),
        paste0("% Source notebook: ", reg_derived_source_notebook),
        paste0("intercept  & ", get_display("reg.inline.linked_values", "mod0_intercept_estimate"), " & ", get_display("reg.inline.linked_values", "mod0_intercept_std_error"), " & ", get_display("reg.inline.linked_values", "mod0_intercept_t_value"), " & ", get_display("reg.inline.linked_values", "mod0_intercept_p_value"), " \\\\"),
        paste0("production &     ", get_display("reg.inline.linked_values", "mod0_production_estimate"), " &      ", get_display("reg.inline.linked_values", "mod0_production_std_error"), " & ", get_display("reg.inline.linked_values", "mod0_production_t_value"), " & ", get_display("reg.inline.linked_values", "mod0_production_p_value"), " \\\\" )
      ),
      metadata = reg_mod0_rows_metadata,
      target_snippet = reg_mod0_rows_target_snippet
    ),
    list(
      filename = "reg-summary-mod1-rows.tex",
      content = c(
        "% Generated by scripts/generate-worked-calculations.R; do not edit by hand.",
        "% Derived from Regression inline-linked notebook values (mod.1 summary rows).",
        paste0("% Registry ID: ", reg_mod1_rows_id),
        paste0("% Source notebook: ", reg_derived_source_notebook),
        paste0("intercept  & ", get_display("reg.inline.linked_values", "mod1_intercept_estimate"), " & ", get_display("reg.inline.linked_values", "mod1_intercept_std_error"), " &  ", get_display("reg.inline.linked_values", "mod1_intercept_t_value"), " & ", get_display("reg.inline.linked_values", "mod1_intercept_p_value"), " \\\\"),
        paste0("production &   ", get_display("reg.inline.linked_values", "mod1_production_estimate"), " &     ", get_display("reg.inline.linked_values", "mod1_production_std_error"), " &  ", get_display("reg.inline.linked_values", "mod1_production_t_value"), " & ", get_display("reg.inline.linked_values", "mod1_production_p_value"), " \\\\"),
        paste0("coolDD     &  ", get_display("reg.inline.linked_values", "mod1_cooldd_estimate"), " &     ", get_display("reg.inline.linked_values", "mod1_cooldd_std_error"), " & ", get_display("reg.inline.linked_values", "mod1_cooldd_t_value"), " & ", get_display("reg.inline.linked_values", "mod1_cooldd_p_value"), " \\\\"),
        paste0("heatDD     &   ", get_display("reg.inline.linked_values", "mod1_heatdd_estimate"), " &     ", get_display("reg.inline.linked_values", "mod1_heatdd_std_error"), " &  ", get_display("reg.inline.linked_values", "mod1_heatdd_t_value"), " & ", get_display("reg.inline.linked_values", "mod1_heatdd_p_value"), " \\\\" )
      ),
      metadata = reg_mod1_rows_metadata,
      target_snippet = reg_mod1_rows_target_snippet
    ),
    list(
      filename = "reg-summary-mod2-rows.tex",
      content = c(
        "% Generated by scripts/generate-worked-calculations.R; do not edit by hand.",
        "% Derived from Regression inline-linked notebook values (mod.2 summary rows).",
        paste0("% Registry ID: ", reg_mod2_rows_id),
        paste0("% Source notebook: ", reg_derived_source_notebook),
        paste0("intercept           &   ", get_display("reg.inline.linked_values", "mod2_intercept_estimate"), " &  ", get_display("reg.inline.linked_values", "mod2_intercept_std_error"), "  &  ", get_display("reg.inline.linked_values", "mod2_intercept_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_intercept_p_value"), " \\\\"),
        paste0("production          &     ", get_display("reg.inline.linked_values", "mod2_production_estimate"), " &      ", get_display("reg.inline.linked_values", "mod2_production_std_error"), "  &  ", get_display("reg.inline.linked_values", "mod2_production_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_production_p_value"), " \\\\"),
        paste0("summer              & ", get_display("reg.inline.linked_values", "mod2_summer_estimate"), " &  ", get_display("reg.inline.linked_values", "mod2_summer_std_error"), "  &  ", get_display("reg.inline.linked_values", "mod2_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_summer_p_value"), " \\\\"),
        paste0("coolDD              &  ", get_display("reg.inline.linked_values", "mod2_cooldd_estimate"), " &     ", get_display("reg.inline.linked_values", "mod2_cooldd_std_error"), "  & ", get_display("reg.inline.linked_values", "mod2_cooldd_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_cooldd_p_value"), " \\\\"),
        paste0("heatDD              &     ", get_display("reg.inline.linked_values", "mod2_heatdd_estimate"), " &      ", get_display("reg.inline.linked_values", "mod2_heatdd_std_error"), "  &  ", get_display("reg.inline.linked_values", "mod2_heatdd_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_heatdd_p_value"), " \\\\"),
        paste0("production : summer &    ", get_display("reg.inline.linked_values", "mod2_production_summer_estimate"), " &      ", get_display("reg.inline.linked_values", "mod2_production_summer_std_error"), "  & ", get_display("reg.inline.linked_values", "mod2_production_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_production_summer_p_value"), " \\\\"),
        paste0("coolDD : summer     &   ", get_display("reg.inline.linked_values", "mod2_cooldd_summer_estimate"), " &     ", get_display("reg.inline.linked_values", "mod2_cooldd_summer_std_error"), "  &  ", get_display("reg.inline.linked_values", "mod2_cooldd_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_cooldd_summer_p_value"), " \\\\"),
        paste0("heatDD  :  summer   &   ", get_display("reg.inline.linked_values", "mod2_heatdd_summer_estimate"), " &     ", get_display("reg.inline.linked_values", "mod2_heatdd_summer_std_error"), "  & ", get_display("reg.inline.linked_values", "mod2_heatdd_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod2_heatdd_summer_p_value"), " \\\\" )
      ),
      metadata = reg_mod2_rows_metadata,
      target_snippet = reg_mod2_rows_target_snippet
    ),
    list(
      filename = "reg-summary-mod3-rows.tex",
      content = c(
        "% Generated by scripts/generate-worked-calculations.R; do not edit by hand.",
        "% Derived from Regression inline-linked notebook values (mod.3 summary rows).",
        paste0("% Registry ID: ", reg_mod3_rows_id),
        paste0("% Source notebook: ", reg_derived_source_notebook),
        paste0("intercept           &   ", get_display("reg.inline.linked_values", "mod3_intercept_estimate"), " & ", get_display("reg.inline.linked_values", "mod3_intercept_std_error"), " &  ", get_display("reg.inline.linked_values", "mod3_intercept_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_intercept_p_value"), " \\\\"),
        paste0("production          &     ", get_display("reg.inline.linked_values", "mod3_production_estimate"), " &      ", get_display("reg.inline.linked_values", "mod3_production_std_error"), " &  ", get_display("reg.inline.linked_values", "mod3_production_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_production_p_value"), " \\\\"),
        paste0("summer              & ", get_display("reg.inline.linked_values", "mod3_summer_estimate"), " & ", get_display("reg.inline.linked_values", "mod3_summer_std_error"), " &  ", get_display("reg.inline.linked_values", "mod3_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_summer_p_value"), " \\\\"),
        paste0("coolDD              &  ", get_display("reg.inline.linked_values", "mod3_cooldd_estimate"), " &    ", get_display("reg.inline.linked_values", "mod3_cooldd_std_error"), " & ", get_display("reg.inline.linked_values", "mod3_cooldd_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_cooldd_p_value"), " \\\\"),
        paste0("heatDD              &       ", get_display("reg.inline.linked_values", "mod3_heatdd_estimate"), " &     ", get_display("reg.inline.linked_values", "mod3_heatdd_std_error"), " &  ", get_display("reg.inline.linked_values", "mod3_heatdd_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_heatdd_p_value"), " \\\\"),
        paste0("production : summer &    ", get_display("reg.inline.linked_values", "mod3_production_summer_estimate"), " &      ", get_display("reg.inline.linked_values", "mod3_production_summer_std_error"), " & ", get_display("reg.inline.linked_values", "mod3_production_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_production_summer_p_value"), " \\\\"),
        paste0("coolDD : summer     &   ", get_display("reg.inline.linked_values", "mod3_cooldd_summer_estimate"), " &    ", get_display("reg.inline.linked_values", "mod3_cooldd_summer_std_error"), " &  ", get_display("reg.inline.linked_values", "mod3_cooldd_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_cooldd_summer_p_value"), " \\\\"),
        paste0("heatDD : summer     &   ", get_display("reg.inline.linked_values", "mod3_heatdd_summer_estimate"), " &    ", get_display("reg.inline.linked_values", "mod3_heatdd_summer_std_error"), " & ", get_display("reg.inline.linked_values", "mod3_heatdd_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod3_heatdd_summer_p_value"), " \\\\" )
      ),
      metadata = reg_mod3_rows_metadata,
      target_snippet = reg_mod3_rows_target_snippet
    ),
    list(
      filename = "reg-summary-mod4-rows.tex",
      content = c(
        "% Generated by scripts/generate-worked-calculations.R; do not edit by hand.",
        "% Derived from Regression inline-linked notebook values (mod.4 summary rows).",
        paste0("% Registry ID: ", reg_mod4_rows_id),
        paste0("% Source notebook: ", reg_derived_source_notebook),
        paste0("intercept         &    ", get_display("reg.inline.linked_values", "mod4_intercept_estimate"), " &   ", get_display("reg.inline.linked_values", "mod4_intercept_std_error"), " &  ", get_display("reg.inline.linked_values", "mod4_intercept_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_intercept_p_value"), " \\\\"),
        paste0("production\\_adj   &     ", get_display("reg.inline.linked_values", "mod4_production_adj_estimate"), " &     ", get_display("reg.inline.linked_values", "mod4_production_adj_std_error"), " & ", get_display("reg.inline.linked_values", "mod4_production_adj_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_production_adj_p_value"), " \\\\"),
        paste0("summer\\_adj       & ", get_display("reg.inline.linked_values", "mod4_summer_adj_estimate"), " & ", get_display("reg.inline.linked_values", "mod4_summer_adj_std_error"), " &  ", get_display("reg.inline.linked_values", "mod4_summer_adj_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_summer_adj_p_value"), " \\\\"),
        paste0("coolDD\\_adj       &   ", get_display("reg.inline.linked_values", "mod4_cooldd_adj_estimate"), " &    ", get_display("reg.inline.linked_values", "mod4_cooldd_adj_std_error"), " & ", get_display("reg.inline.linked_values", "mod4_cooldd_adj_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_cooldd_adj_p_value"), " \\\\"),
        paste0("heatDD\\_adj       &     ", get_display("reg.inline.linked_values", "mod4_heatdd_adj_estimate"), " &     ", get_display("reg.inline.linked_values", "mod4_heatdd_adj_std_error"), " &  ", get_display("reg.inline.linked_values", "mod4_heatdd_adj_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_heatdd_adj_p_value"), " \\\\"),
        paste0("prod\\_summer\\_adj &    ", get_display("reg.inline.linked_values", "mod4_prod_summer_adj_estimate"), " &      ", get_display("reg.inline.linked_values", "mod4_prod_summer_adj_std_error"), " & ", get_display("reg.inline.linked_values", "mod4_prod_summer_adj_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_prod_summer_adj_p_value"), " \\\\"),
        paste0("cool\\_summer\\_adj &    ", get_display("reg.inline.linked_values", "mod4_cool_summer_adj_estimate"), " &    ", get_display("reg.inline.linked_values", "mod4_cool_summer_adj_std_error"), " &  ", get_display("reg.inline.linked_values", "mod4_cool_summer_adj_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_cool_summer_adj_p_value"), " \\\\"),
        paste0("heat\\_summer\\_adj &   ", get_display("reg.inline.linked_values", "mod4_heat_summer_adj_estimate"), " &    ", get_display("reg.inline.linked_values", "mod4_heat_summer_adj_std_error"), " & ", get_display("reg.inline.linked_values", "mod4_heat_summer_adj_t_value"), " & ", get_display("reg.inline.linked_values", "mod4_heat_summer_adj_p_value"), " \\\\" )
      ),
      metadata = reg_mod4_rows_metadata,
      target_snippet = reg_mod4_rows_target_snippet
    ),
    list(
      filename = "reg-summary-mod5-rows.tex",
      content = c(
        "% Generated by scripts/generate-worked-calculations.R; do not edit by hand.",
        "% Derived from Regression inline-linked notebook values (mod.5 summary rows).",
        paste0("% Registry ID: ", reg_mod5_rows_id),
        paste0("% Source notebook: ", reg_derived_source_notebook),
        paste0("intercept           &   ", get_display("reg.inline.linked_values", "mod5_intercept_estimate"), " & ", get_display("reg.inline.linked_values", "mod5_intercept_std_error"), " &  ", get_display("reg.inline.linked_values", "mod5_intercept_t_value"), " & ", get_display("reg.inline.linked_values", "mod5_intercept_p_value"), " \\\\"),
        paste0("production          &     ", get_display("reg.inline.linked_values", "mod5_production_estimate"), " &      ", get_display("reg.inline.linked_values", "mod5_production_std_error"), " & ", get_display("reg.inline.linked_values", "mod5_production_t_value"), " & ", get_display("reg.inline.linked_values", "mod5_production_p_value"), " \\\\"),
        paste0("summer              & ", get_display("reg.inline.linked_values", "mod5_summer_estimate"), " & ", get_display("reg.inline.linked_values", "mod5_summer_std_error"), " &  ", get_display("reg.inline.linked_values", "mod5_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod5_summer_p_value"), " \\\\"),
        paste0("coolDD              &  ", get_display("reg.inline.linked_values", "mod5_cooldd_estimate"), " &    ", get_display("reg.inline.linked_values", "mod5_cooldd_std_error"), " & ", get_display("reg.inline.linked_values", "mod5_cooldd_t_value"), " & ", get_display("reg.inline.linked_values", "mod5_cooldd_p_value"), " \\\\"),
        paste0("production : summer &    ", get_display("reg.inline.linked_values", "mod5_production_summer_estimate"), " &      ", get_display("reg.inline.linked_values", "mod5_production_summer_std_error"), " & ", get_display("reg.inline.linked_values", "mod5_production_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod5_production_summer_p_value"), " \\\\"),
        paste0("coolDD : summer     &   ", get_display("reg.inline.linked_values", "mod5_cooldd_summer_estimate"), " &    ", get_display("reg.inline.linked_values", "mod5_cooldd_summer_std_error"), " &  ", get_display("reg.inline.linked_values", "mod5_cooldd_summer_t_value"), " & ", get_display("reg.inline.linked_values", "mod5_cooldd_summer_p_value"), " \\\\" )
      ),
      metadata = reg_mod5_rows_metadata,
      target_snippet = reg_mod5_rows_target_snippet
    )
  )
}
