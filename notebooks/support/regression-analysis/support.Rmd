...
write_values_entry(
  "reg.inline.linked_values.json",
  list(
    id = "reg.inline.linked_values",
    kind = "inline_values",
    source_notebook = "notebooks/support/regression-analysis/support.Rmd",
    source_context = "Model diagnostics and refined-model summary values used in chapter prose",
    source_dataset = "USSteamCo model diagnostics",
    target_snippet = "generated/worked-calculations/reg-inline-linked-values.tex",
    tolerance = 1e-8,
    language_scope = "r",
    equation_labels = c("eq:annual_prediction_interval"),
    values = c(
      {
        build_coef_table_values <- function(model, model_prefix, row_specs) {
          ...
          for (spec in row_specs) {
            ...
            value_rows <- c(
              ...
              list(
                list(
                  id = sprintf("reg.inline.%s_%s_estimate", model_prefix, row_key),
                  role = sprintf("%s_%s_estimate", model_prefix, row_key),
                  raw = as.numeric(coef_mat[row_name, "Estimate"]),
                  format = spec$estimate_format
                ),
                list(
                  id = sprintf("reg.inline.%s_%s_std_error", model_prefix, row_key),
                  role = sprintf("%s_%s_std_error", model_prefix, row_key),
                  raw = as.numeric(coef_mat[row_name, "Std. Error"]),
                  format = spec$std_error_format
                ),
                list(
                  id = sprintf("reg.inline.%s_%s_t_value", model_prefix, row_key),
                  role = sprintf("%s_%s_t_value", model_prefix, row_key),
                  raw = as.numeric(coef_mat[row_name, "t value"]),
                  format = spec$t_value_format
                ),
                list(
                  id = sprintf("reg.inline.%s_%s_p_value", model_prefix, row_key),
                  role = sprintf("%s_%s_p_value", model_prefix, row_key),
                  raw = as.numeric(coef_mat[row_name, "Pr(>|t|)"]),
                  format = spec$p_value_format
                )
              )
            )
          }
        ...
        mod0_specs <- list(
          list(row_name = "(Intercept)", row_key = "intercept", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:4"),
          list(row_name = "production", row_key = "production", estimate_format = "number:2", std_error_format = "number:2", t_value_format = "number:3", p_value_format = "number:4")
        )

        mod1_specs <- list(
          list(row_name = "(Intercept)", row_key = "intercept", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:4"),
          list(row_name = "production", row_key = "production", estimate_format = "number:2", std_error_format = "number:3", t_value_format = "number:4", p_value_format = "number:4"),
          list(row_name = "coolDD", row_key = "cooldd", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:4"),
          list(row_name = "heatDD", row_key = "heatdd", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:4")
        )

        mod2_specs <- list(
          list(row_name = "(Intercept)", row_key = "intercept", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "production", row_key = "production", estimate_format = "number:2", std_error_format = "number:3", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "summer", row_key = "summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "coolDD", row_key = "cooldd", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "heatDD", row_key = "heatdd", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "production:summer", row_key = "production_summer", estimate_format = "number:2", std_error_format = "number:3", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "summer:coolDD", row_key = "cooldd_summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "summer:heatDD", row_key = "heatdd_summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5")
        )

        mod3_specs <- list(
          list(row_name = "(Intercept)", row_key = "intercept", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "production", row_key = "production", estimate_format = "number:2", std_error_format = "number:2", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "summer", row_key = "summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "coolDD", row_key = "cooldd", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "heatDD", row_key = "heatdd", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "production:summer", row_key = "production_summer", estimate_format = "number:2", std_error_format = "number:2", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "coolDD:summer", row_key = "cooldd_summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5"),
          list(row_name = "heatDD:summer", row_key = "heatdd_summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:4", p_value_format = "number:5")
        )

        mod4_specs <- list(
          list(row_name = "(Intercept)", row_key = "intercept", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "production_adj", row_key = "production_adj", estimate_format = "number:2", std_error_format = "number:3", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "summer_adj", row_key = "summer_adj", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "coolDD_adj", row_key = "cooldd_adj", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "heatDD_adj", row_key = "heatdd_adj", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "prod_summer_adj", row_key = "prod_summer_adj", estimate_format = "number:2", std_error_format = "number:2", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "cool_summer_adj", row_key = "cool_summer_adj", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "heat_summer_adj", row_key = "heat_summer_adj", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6")
        )

        mod5_specs <- list(
          list(row_name = "(Intercept)", row_key = "intercept", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "production", row_key = "production", estimate_format = "number:2", std_error_format = "number:2", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "summer", row_key = "summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "coolDD", row_key = "cooldd", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "production:summer", row_key = "production_summer", estimate_format = "number:2", std_error_format = "number:2", t_value_format = "number:3", p_value_format = "number:6"),
          list(row_name = "coolDD:summer", row_key = "cooldd_summer", estimate_format = "integer", std_error_format = "integer", t_value_format = "number:3", p_value_format = "number:6")
        )

        c(
          build_coef_table_values(ussteamco.mod.0, "mod0", mod0_specs),
          build_coef_table_values(ussteamco.mod.1, "mod1", mod1_specs),
          build_coef_table_values(ussteamco.mod.2, "mod2", mod2_specs),
          build_coef_table_values(ussteamco.mod.3, "mod3", mod3_specs),
          build_coef_table_values(ussteamco.mod.4, "mod4", mod4_specs),
          build_coef_table_values(ussteamco.mod.5, "mod5", mod5_specs)
        )
      },
      list(
      list(id = "reg.inline.mod3_w", role = "mod3_w", raw = 0.9480, format = "number:4"),
      list(id = "reg.inline.mod3_shapiro_p", role = "mod3_shapiro_p", raw = 0.09045, format = "number:5"),
      list(id = "reg.inline.mod3_bp", role = "mod3_bp", raw = 7.1466, format = "number:4"),
      list(id = "reg.inline.mod3_bp_p", role = "mod3_bp_p", raw = 0.0674, format = "number:4"),
      list(id = "reg.inline.mod3_bg", role = "mod3_bg", raw = 7.1466, format = "number:4"),
      list(id = "reg.inline.mod3_bg_p", role = "mod3_bg_p", raw = 0.06737, format = "number:5"),
      list(id = "reg.inline.mod4_bg", role = "mod4_bg", raw = 2.2151, format = "number:4"),
      list(id = "reg.inline.mod4_bg_p", role = "mod4_bg_p", raw = 0.529, format = "number:3"),
      list(id = "reg.inline.mod5_bp", role = "mod5_bp", raw = 7.0367, format = "number:4"),
      list(id = "reg.inline.mod5_bp_p", role = "mod5_bp_p", raw = 0.2179, format = "number:4"),
      list(id = "reg.inline.mod5_bg", role = "mod5_bg", raw = 5.1992, format = "number:4"),
      list(id = "reg.inline.mod5_bg_p", role = "mod5_bg_p", raw = 0.1578, format = "number:4"),
      list(id = "reg.inline.mod5_w", role = "mod5_w", raw = 0.94875, format = "number:5"),
      list(id = "reg.inline.mod5_shapiro_p", role = "mod5_shapiro_p", raw = 0.09554, format = "number:5"),
      list(id = "reg.inline.mod0_intercept", role = "mod0_intercept", raw = 4897663, format = "integer"),
      list(id = "reg.inline.mod0_slope", role = "mod0_slope", raw = 18.99, format = "number:2"),
      list(id = "reg.inline.mod0_x_star", role = "mod0_x_star", raw = 606400, format = "integer"),
      list(id = "reg.inline.mod0_y_hat", role = "mod0_y_hat", raw = 16414429, format = "integer"),
      list(id = "reg.inline.mod0_t_99", role = "mod0_t_99", raw = 2.728, format = "number:3"),
      list(id = "reg.inline.mod0_residual_sd", role = "mod0_residual_sd", raw = 4112487, format = "integer"),
      list(id = "reg.inline.mod0_sample_size", role = "mod0_sample_size", raw = 36, format = "integer"),
      list(id = "reg.inline.mod0_x_mean", role = "mod0_x_mean", raw = 471663, format = "integer"),
      list(id = "reg.inline.mod0_df", role = "mod0_df", raw = 35, format = "integer"),
      list(id = "reg.inline.mod0_sxx", role = "mod0_sxx", raw = 29945297385, format = "integer"),
      list(id = "reg.inline.mod0_precision_99", role = "mod0_precision_99", raw = 11470711, format = "integer"),
      list(id = "reg.inline.mod0_r_squared", role = "mod0_r_squared", raw = summary(ussteamco.mod.0)$r.squared, format = "number:3"),
      list(id = "reg.inline.mod1_residual_sd", role = "mod1_residual_sd", raw = summary(ussteamco.mod.1)$sigma, format = "integer"),
      list(id = "reg.inline.mod1_r_squared", role = "mod1_r_squared", raw = summary(ussteamco.mod.1)$r.squared, format = "number:3"),
      list(id = "reg.inline.mod2_residual_sd", role = "mod2_residual_sd", raw = summary(ussteamco.mod.2)$sigma, format = "integer"),
      list(id = "reg.inline.mod2_r_squared", role = "mod2_r_squared", raw = summary(ussteamco.mod.2)$r.squared, format = "number:3")
      )
    )
  )
)
