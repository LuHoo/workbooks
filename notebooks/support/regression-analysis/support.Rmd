...
# Keep the model self-contained for later car diagnostics during notebook renders.
ussteamco.mod.2$call$data <- model.frame(ussteamco.mod.2)
...
ussteamco.mod.3$call$data <- model.frame(ussteamco.mod.3)
